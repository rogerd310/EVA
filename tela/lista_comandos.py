...
class JanelaC (QMainWindow):
    def __init__(self):
        ...
        """)
        # sara
        ls = ['temperatura do sistema', 'tire print', 'desligar o pc', 'abrir calculadora',
              'relatório', 'esvaziar lixeira', 'fechar janela', 'esconder janela',
              # pesquisa
              'pesquisa',
              # sites
              'abrir google', 'abrir youtube', 'abrir netflix', 'abrir gmail',
              'abrir facebook', 'abrir compras',
              # programas
              'abrir steam', 'abrir touch portal',
              # outros
              'música', 'playlist', 'easter egg',]
